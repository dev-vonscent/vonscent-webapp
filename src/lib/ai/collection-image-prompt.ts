...
export const COLLECTION_BASE_PROMPT = [
  ...
  "- The tight group of four is centred horizontally in the frame, with equal",
  "  empty space on its left and right.",
  "- The bottles' bases sit on a line at 72% of the frame height from the top;",
  "  the tallest bottle reaches up to about 36% from the top. The surface in",
  "  front of the bottles fills the bottom of the frame.",
