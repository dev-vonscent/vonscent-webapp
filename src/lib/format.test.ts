...
describe("formatDate / formatDateTime", () => {
  ...
  it("adds a 24-hour clock time with seconds", () => {
    expect(formatDateTime("2026-09-08T07:34:00Z")).toBe("2026.09.08 15:34:00");
  });
  ...
  it("reads the clock in Ulaanbaatar, not UTC", () => {
    ...
    expect(formatDateTime("2026-09-08T16:05:00Z")).toBe("2026.09.09 00:05:00");
    expect(formatDate("2026-09-08T16:05:00Z")).toBe("2026.09.09");
  });

  it("keeps midnight at 00, not 24", () => {
    expect(formatDateTime("2026-09-08T16:00:00Z")).toBe("2026.09.09 00:00:00");
  });
});
