/**
 * Grain texture as an inline SVG data-URI — shared by the auth backdrop and
 * the home hero so dark surfaces don't feel flat. Use as backgroundImage with
 * a low opacity + mix-blend-overlay.
 */
export const GRAIN =
