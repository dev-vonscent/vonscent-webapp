...
/**
 * Захиалгаа өөрчилж болох сүүлчийн секунд — «09/21 23:59:59».
 *
 ...
 * хугацаа байгаа мэт уншигддаг. Тиймээс хэрэглэгчид эцсийн мөчийг
 * (өмнөх өдрийн 23:59:59) харуулна — секунд хүртэл бичсэнээр «23:59 хүртэл
 * юү, 23:59-д дуусах уу» гэсэн эргэлзээ ч үлдэхгүй.
 */
export function formatEditCutoff(day: string): string {
  const last = dayAt(day, ORDER_EDIT_CUTOFF_HOUR).getTime() - 1_000;
  ...
  // залгана.
  return format(new TZDate(last, UB_TIMEZONE), "MM/dd HH:mm:ss");
}
