...
function Message({
  ...
  switch (state) {
    ...
    case "invalid":
      return <>Имэйл хаяг буруу байна. Жишээ: name@example.com</>;
    case "done":
      return (
        <>Баярлалаа! Захиалгын мэдэгдэл таны имэйл хаяг руу илгээгдэх болно.</>
      );
    case "taken":
      return <>Энэ имэйл хаяг өөр бүртгэлд холбогдсон байна.</>;
    case "error":
