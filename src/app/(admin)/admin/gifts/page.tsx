  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        // description="Худалдан авагч захиалгын барааны дүнгийн 200,000₮ тутамд (купоны дараах, хүргэлт ороогүй дүнгээр) доорх уснуудаас 1 ширхэг 1мл дээж бэлгээр сонгоно. 6–8 ус байлгахыг зөвлөнө; сар бүр солих шаардлагагүй, хүссэн үедээ шинэчилнэ."
      />
