...
- [x] **4.9** `msw` — Supabase/QPay mock ✓ 2026-08-23 — QPay тестүүд fetch stub-ын оронд msw network mock болсон (`src/test/qpay-handlers.ts` дахин ашиглагдана, `createInvoice`-д шинэ тест); Supabase-д одоогоор msw шаардсан тест байхгүй — хэрэгцээ гарахад ижил загвараар нэмнэ
