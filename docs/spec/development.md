...
### 6.1 Савны түгжээ — хоосон сав (0095)

Дээрх бүхэн нь эх савны **шингэн** ml-ийн тухай. Түүнээс **тусдаа** нөөц бол
декант цутгах **хоосон сав**: ml бүрт гурван өнгөтэй ирдэг ба өнгө нь барааны
хүйсээр (`products.gender`) хуваарилагдана.

- `bottle_stock (gender, ml, is_active, note)` — 12 мөр. Админ
  `/admin/bottles`-оос унтраална; тэр хослолтой БҮХ бараа тэр хэмжээгээрээ
  зарагдахаа болино.
- `product_variants.is_active` (бараа тус бүрийн гарын унтраалга) **хөндөгдөхгүй**:
  сав ирээд түгжээг нээхэд өмнө нь зориуд хаасан хэмжээ нээгдэх ёсгүй.
- Ховор тохиолдолд (өөр өнгийн саванд цутгах) нэг бараа/хэмжээг
  `product_variants.bottle_override`-оор чөлөөлнө. Түгжээг нээхэд админаас
  эдгээрийг цуцлахыг асууна — үлдвэл ДАРААГИЙН түгжээнд чимээгүй нэвчинэ.
- Зарагдах эсэхийн дүрэм нэг газарт: SQL талд `variant_sellable()`, TS талд
  `features/products/sellable.ts`. `catalog_items`, `global_search()`,
  `product_variants_for()`, `mapProduct()` дөрвүүлээ эднээс уншина.
- `place_order()` нь reserve хийхээсээ өмнө савыг шалгаж `BOTTLE_UNAVAILABLE`
  гэж унана — сагс localStorage-д долоо хоногоор суудгийн эсрэг сүүлийн
  хамгаалалт.
