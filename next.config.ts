...
const nextConfig: NextConfig = {
  ...
  /**
   * Router cache — хуудас хооронд буцаж явахад дахин татахгүй (backlog H2).
   *
   * Next-ийн өгөгдмөл нь динамик хуудсыг 0 секунд санадаг: каталогаас барааруу
   * ороод БУЦАХАД бүхэл хуудас дахин серверээс ирдэг. Дэлгүүрийн өгөгдөл
   * (үнэ, үлдэгдэл) секунд тутам хөдөлдөггүй тул хагас минут санахад хангалттай;
   * ISR-ээр бэлдсэн статик хуудсыг 5 минут санана.
   *
   * ⚠️ ЭНЭ НЬ АДМИНД НӨХЦӨЛ ТАВЬЖ БАЙНА. Кэш нь БРАУЗАР дээрх router cache тул
   * серверийн `dynamic = "force-dynamic"` ч, route handler дотор `revalidatePath`
   * дуудсан ч түүнийг цэвэрлэхгүй. Тиймээс өгөгдөл ӨӨРЧИЛСНИЙ дараа өөр хуудас
   * руу шилждэг бүх админ урсгал `router.refresh()`-ийг `router.push()`-ийн
   * ӨМНӨ дуудах ёстой (product-form, product-edit-form, collection-form).
   * Үгүй бол оператор бараа хадгалаад/устгаад жагсаалт руу буцахад 30 секунд
   * хүртэл хуучин жагсаалт — устгасан бараа байгаа юм шиг — харагдана.
   */
  experimental: {
